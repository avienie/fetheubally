...
export default function HeroSection() {
  ...
  return (
    <section className="bg-[#F5F5F5] text-center overflow-hidden">
      {/* teks compact supaya tidak makan banyak space */}
      <div className="pt-6 px-6">
        <h1 className="text-[#0B2559] text-5xl font-extrabold tracking-wide leading-tight">
          ADAPT. THRIVE. SUCEED.
        </h1>
        <h2 className="mt-2 text-xl font-bold text-[#1a1a1a]">
          Welcome to The UB Ally!
        </h2>
        <p className="mt-2 max-w-xs mx-auto text-sm leading-relaxed text-gray-600">
      ...
      {/* image natural ratio, button overlay */}

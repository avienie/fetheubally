...
const weekCards = [
  ...
  },
  {
    ...
    desc: "Physical routes secured! Now, it's time to conquer the digital realm. Master your academic portal (SIAM), secure your class schedule, and get your free campus Wi-Fi access sorted!",
    icon: "💻",
  },
  {
    id: "week3",
    ...
    desc: "Academics are important, but connections make your college years unforgettable. Let's find your community, explore student organizations (UKM), and unlock the central library access!",
    icon: "🌍",
  },
  {
    id: "week4",
    ...
    desc: "You've secured your routes, schedules, and connections. Now, it's time for the true test of a university student: surviving on a budget! Explore the legendary student food spots around campus, enjoy the local culture, and claim your final certificate.",
    icon: "🍜",
  },
];

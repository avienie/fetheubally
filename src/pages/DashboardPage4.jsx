        ...
        <div className="col-span-8 bg-white border-[5px] border-[#0F2B5B] rounded-[35px] shadow-xl p-6">
          ...
          <div className="mt-5 flex items-center gap-3">
            ...
            <h1 className="text-[48px] font-black text-[#0F2B5B]">
              Week 4 - The Malang Culinary Explorer 
            </h1>
          </div>

          {/* DESCRIPTION */}
          <p className="text-[28px] text-[#333333] leading-[42px] mt-4">
            You've secured your routes, schedules, and connections. Now, it's time for the true test of a university student: surviving on a budget! Explore the legendary student food spots around campus, enjoy the local culture, and claim your final certificate.
          </p>
